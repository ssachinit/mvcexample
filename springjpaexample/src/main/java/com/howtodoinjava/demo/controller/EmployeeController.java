...
//        return departments;
          ...
          ArrayList<DepartmentEntity> departments = new ArrayList<DepartmentEntity>();
          departments.add(new DepartmentEntity(-1, "Select Department"));
          departments.add(new DepartmentEntity(1, "Human Resource"));
          departments.add(new DepartmentEntity(2, "Finance"));
          departments.add(new DepartmentEntity(3, "Information Technology"));
          return departments;
